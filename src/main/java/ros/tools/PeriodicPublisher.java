...
public class PeriodicPublisher {
    ...
    public void setMsg(Object msg) {
        if (LOGGER.isTraceEnabled() && this.timerTask != null && msg == null) {
            LOGGER.trace("PeriodicPublisher is not setting message because new message is null and publisher is currently publishing.");
        }
        this.msg = msg;
    }
